...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vee_validate__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__locales_fr_js__ = __webpack_require__(29);
...
// Merge the locales.
__WEBPACK_IMPORTED_MODULE_3_vee_validate__["Validator"].addLocale(__WEBPACK_IMPORTED_MODULE_4__locales_fr_js__["a" /* default */]);
var config = {
	locale: 'fr'
};
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
	...
	methods: {
		onSubmit: function onSubmit() {
			this.form.submit('post', 'test').then(function (data) {
...
var Form = function () {
	...
	_createClass(Form, [{
		...
		value: function data() {
			var data = {};
			for (var proprety in this.originalData) {
				data[proprety] = this[proprety];
			}
			return data;
		}
	}, {
...
var messages = {
  ...
  after: function after(field, _ref) {
    ...
    return field + ' doit \xEAtre post\xE9rieur \xE0 ' + target + '.';
  },
  alpha_dash: function alpha_dash(field) {
    return field + ' ne peut contenir que des caract\xE8res alpha-num\xE9riques, tirets ou soulign\xE9s.';
  },
  alpha_num: function alpha_num(field) {
    return field + ' ne peut contenir que des caract\xE8res alpha-num\xE9riques.';
  },
  alpha_spaces: function alpha_spaces(field) {
    return field + ' ne peut contenir que des lettres ou des espaces.';
  },
  alpha: function alpha(field) {
    return field + ' ne peut contenir que des lettres.';
  },
  before: function before(field, _ref3) {
    var _ref4 = _slicedToArray(_ref3, 1),
        target = _ref4[0];

    return field + ' doit \xEAtre ant\xE9rieur \xE0 ' + target + '.';
  },
  between: function between(field, _ref5) {
    ...
    return field + ' doit \xEAtre compris entre ' + min + ' et ' + max + '.';
  },
  confirmed: function confirmed(field, _ref7) {
    var _ref8 = _slicedToArray(_ref7, 1),
        confirmedField = _ref8[0];

    return field + ' ne correspond pas \xE0 ' + confirmedField + '.';
  },
  ...
  date_between: function date_between(field, _ref9) {
    ...
    return field + ' doit \xEAtre situ\xE9 entre ' + min + ' et ' + max + '.';
  },
  date_format: function date_format(field, _ref11) {
    var _ref12 = _slicedToArray(_ref11, 1),
        format = _ref12[0];

    return field + ' doit \xEAtre au format ' + format + '.';
  },
  decimal: function decimal(field) {
    ...
    return field + ' doit \xEAtre un nombre et peut contenir ' + (decimals === '*' ? '' : decimals) + ' d\xE9cimales.';
  },
  digits: function digits(field, _ref15) {
    var _ref16 = _slicedToArray(_ref15, 1),
        length = _ref16[0];

    return field + ' doit \xEAtre un nombre entier de ' + length + ' chiffres.';
  },
  dimensions: function dimensions(field, _ref17) {
    ...
    return field + ' doit avoir une taille de ' + width + ' pixels par ' + height + ' pixels.';
  },
  email: function email(field) {
    return field + ' doit \xEAtre une adresse e-mail valide.';
  },
  ext: function ext(field) {
    return field + ' doit \xEAtre un fichier valide.';
  },
  image: function image(field) {
    return field + ' doit \xEAtre une image.';
  },
  in: function _in(field) {
    return field + ' doit \xEAtre une valeur valide.';
  },
  ip: function ip(field) {
    return field + ' doit \xEAtre une adresse IP.';
  },
  max: function max(field, _ref19) {
    var _ref20 = _slicedToArray(_ref19, 1),
        length = _ref20[0];

    return field + ' ne peut pas contenir plus de ' + length + ' caract\xE8res.';
  },
  max_value: function max_value(field, _ref21) {
    var _ref22 = _slicedToArray(_ref21, 1),
        max = _ref22[0];

    return field + ' doit avoir une valeur de ' + max + ' ou moins.';
  },
  mimes: function mimes(field) {
    return field + ' doit avoir un type MIME valide.';
  },
  min: function min(field, _ref23) {
    var _ref24 = _slicedToArray(_ref23, 1),
        length = _ref24[0];

    return field + ' doit contenir au minimum ' + length + ' caract\xE8res.';
  },
  min_value: function min_value(field, _ref25) {
    var _ref26 = _slicedToArray(_ref25, 1),
        min = _ref26[0];

    return field + ' doit avoir une valeur de ' + min + ' ou plus.';
  },
  not_in: function not_in(field) {
    return field + ' doit \xEAtre une valeur valide.';
  },
  numeric: function numeric(field) {
    return field + ' ne peut contenir que des chiffres.';
  },
  ...
  size: function size(field, _ref27) {
    ...
    return field + ' doit avoir un poids inf\xE9rieur ' + _size + ' KB.';
  },
  url: function url(field) {
    return field + ' n\'est pas une URL valide.';
  }
};
